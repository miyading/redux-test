...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeStore = __webpack_require__(194);

	var _changeStore2 = _interopRequireDefault(_changeStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeActions = __webpack_require__(193);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(_hello2.default, { actions: actions, text: text }),
	        React.createElement(_change2.default, { actions: actions })
	      );
	    }
	  }]);
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    actions: (0, _redux.bindActionCreators)({ changeText: _changeActions.changeText, buttonClick: _changeActions.buttonClick }, dispatch)
	  };
	}
...
/***/ function(module, exports) {
	...
	var buttonClick = exports.buttonClick = function buttonClick() {
	  return {
	    type: 'BUTTON_CLICK'
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeReducer = __webpack_require__(195);

	function store(myApp) {
	  return (0, _redux.createStore)(myApp);
	}
